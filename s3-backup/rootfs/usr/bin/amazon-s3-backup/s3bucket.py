...
class S3Bucket:
    def __init__(self, s3_vendor: str, bucket_name: str, bucket_region: str, storage_class: str):
        ...
        if self.s3_vendor == 'WASABI':
            self.s3_client = boto3.client("s3", endpoint_url='https://s3.wasabisys.com', **aws_config)
        else:
